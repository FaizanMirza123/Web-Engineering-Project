    ...
    >
      <div className="min-h-screen bg-cyber-black flex flex-col items-center">
        ...
        <div className="py-8 ">
          ...
          <h2 className="text-2xl font-bold text-cyber-blue text-center inline ml-2">
            Attack Vector
          </h2>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 w-full max-w-7xl pb-8">
          ...
          <div className="bg-cyber-dark border border-cyber-blue rounded-lg p-6 flex-1 min-w-[400px] max-w-[600px] text-white shadow-lg hover:shadow-cyber-blue transition-shadow">
            ...
            <p className="text-gray- py-4">
              Learn how attackers can manipulate SQL queries to access
              unauthorized data and how to prevent these attacks.
            </p>
            <button
              className="animate-set px-6 py-3 border-2 border-cyber-blue
         text-cyber-blue text-[1.125rem] font-semibold hover:bg-cyber-fade transition-colors
         rounded-[6px]"
          ...
          <div className="bg-cyber-dark border border-cyber-blue rounded-lg p-6 flex-1 min-w-[400px] max-w-[600px] text-white shadow-lg hover:shadow-cyber-blue transition-shadow">
            ...
            <p className="text-white-400 py-4">
              Explore cross-site scripting vulnerabilities where malicious
              scripts are injected into trusted websites..
            </p>
            <button
              className="animate-set2 px-6 py-3 border-2 border-cyber-purple
         ...
         rounded-[6px]"
          ...
          <div className="bg-cyber-dark border border-cyber-blue rounded-lg p-6 flex-1 min-w-[400px] max-w-[600px] text-white shadow-lg hover:shadow-cyber-blue transition-shadow">
            ...
            <button
              className="animate-set3 px-6 py-3 border-2 border-cyber-green
        ...
        <div className="flex flex-wrap justify-center gap-8 px-8 w-full max-w-7xl pb-16">
          <div className="bg-cyber-dark border border-cyber-blue rounded-lg p-6 flex-1 min-w-[250px] max-w-[1120px] text-white shadow-lg hover:shadow-cyber-blue transition-shadow">
            <ol className="list-decimal list-inside text-gray-300 text-lg space-y-4 marker:text-cyber-blue">
              ...
              <li>
                Explore the interactive demonstration to understand how the
                attack works.
              </li>
              <li>
                Learn about prevention techniques and best practices to protect
                against these attacks.
              </li>
              <li>
                Test your knowledge with practical exercises in our safe
                environment.
              </li>
            </ol>
          </div>
