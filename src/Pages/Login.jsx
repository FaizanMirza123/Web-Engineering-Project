...
import { useNavigate } from 'react-router-dom';
  ...
  export default function Login() {
    ...
    const handleSubmit = async (e) => {
      ...
      const confirmPassword = pass2.current?.value;
    ...
    return (
            ...
            <p className="mt-4 text-center">
              {isLogin ? (
                <>
                  ...
                  <button onClick={toggleForm} className="text-blue-500">Sign Up</button>
                </>
            ) : (
              <>
      ...
      <div className="w-1/2 bg-black flex items-center justify-center text-white">
        <div className="max-w-sm text-center">
          ...
          <p className="text-sm">Don't have an account? Sign up to get started!</p>
        </div>
      </div>
    </div>
  );
