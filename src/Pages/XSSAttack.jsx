  ...
  return (
    <div className="bg-gray-950 text-white min-h-screen px-10 py-6 space-y-8">
      <h1 className="text-4xl font-bold">
        Cross-Site <span className="text-purple-600">{props.type}</span> (XSS
        Attack)
      </h1>
      <p className="text-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-900 p-4 rounded-lg">
          ...
          <p className="text-base leading-relaxed">
            ...
            malicious code, generally in the form of browser-side scripts, to
            different end users. These attacks can steal data, hijack sessions,
            ...
            <div className="bg-slate-900 p-3 rounded-lg">
              ...
              <div className="max-h-40 overflow-y-auto bg-gray-800 p-2 rounded mb-2">
                {comments.map((comment, index) => (
                  <div key={index} className="mb-2 bg-slate-700 p-2 rounded">
