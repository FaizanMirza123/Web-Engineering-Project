          ...
          <section className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-gray-800 p-6 rounded-lg">
              ...
              <p className="leading-relaxed">
                SQL injection occurs when user-supplied data is included
                directly in SQL queries without proper validation or escaping.
                Attackers can manipulate your database, bypass authentication,
            ...
            <div className="space-y-6">
              <div className="bg-gray-800 p-4 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    Using <code>OR 1=1</code> to bypass login
                  </li>
                  <li>
                    Appending <code>; DROP TABLE users;</code>
                  </li>
...
`}
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p>
                Object-Relational Mapping libraries (e.g. Sequelize, TypeORM)
                abstract away raw SQL and help prevent injection.
              </p>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p>
                Database accounts used by your app should have only the minimal
