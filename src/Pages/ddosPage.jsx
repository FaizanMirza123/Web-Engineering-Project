...
>>>>>>>> 6102ec8b4d7514ec57aad7048aa43b480a5263c0:src/ddosPage.jsx
  ...
  return (
    <div className="px-2  py-5 text-center">
      ...
      <p className="text-center">
        Distributed Denial of Service (DDoS) attacks attempt to disrupt normal
        traffic to a targeted server, service, or network by overwhelming it
        ...
        <div class="card col-md-3 col-9 mx-1 my-3 p-4">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-grey">
              A DDoS attack uses multiple compromised computer systems to target
              a single system, causing a denial of service for users of the
              targeted resource. The flood of incoming traffic and requests
              forces the target to slow down or even crash and shut down.
            </p>
          </div>
        </div>
      ...
      <div className="test-section mt-5 mb-2">
        ...
        <input
          ...
          ref={durationRef}
        />
        <button className="startTestingBtn col-10 my-2" onClick={startAttack}>
          Start Testing
        </button>
      </div>
      <h4 className="text-center text-cyber-green">Server Logs</h4>
        ...
        <div className="card col-9 text-start">
          <div className="d-inline-flex text-center justify-content-center">
            ...
            <p>
              ...
              outages, financial losses, and damage to reputation. Implementing
              effective protection measures is essential.
            </p>
          </div>
          ...
          <h4 className="text-cyber-green">1. Increase Network Bandwidth</h4>
          <p>
            Having more bandwidth than you need can help absorb the impact of a
            DDoS attack.
          </p>
          ...
          <p>
            A CDN can help distribute traffic across multiple servers, reducing
          ...
          <div className="cyber-terminal">
            <pre>
              ...
              INPUT -p tcp --dport 80 -m limit --limit 25/minute --limit-burst
              100 -j ACCEPT
            </pre>
          </div>
          <h4 className="text-cyber-green">4. Use DDoS Protection Services</h4>
          <p>
            Consider using third-party DDoS protection services that can help
            mitigate attacks.
          </p>
